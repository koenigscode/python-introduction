\section{Basic Syntax}
  ...
  \subsection{Strings And Comments}
    ...
    \subsubsection{String Formatting}
      ...
      \begin{enumerate}
        \bitem{Making everything a string:} \mintinline{python}{"Python" + str(101)}
        \bitem{Modulo Operator:} \mintinline{python}{"Python %s" % (101)} \\
        ...
        \bitem{Format Method:} \mintinline{python}{"Python {}".format(101)}
        \bitem{F-Strings:} \mintinline{python}{f"Python {101}"}
      \end{enumerate}
