\section{Functions}
  ...
  Note that \textbf{optional parameters} must be the last arguments in the function defintion.
  So \mintinline{python}{def my_function(x=1, y):} is not a valid defintion.
  ...
  As you can see on line 9 you can \textbf{set a parameter by it's variable name}
  instead of position.
