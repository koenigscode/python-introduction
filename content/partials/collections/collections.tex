\section{Collections}
  ...
  \subsection{List} \label{List}
    ...
    \begin{itemize}
      ...
      \bitem{Access Item:} \mintinline{python}{item = l[3]} \sep{,}
      ...
      \begin{itemize}
          ...
          \bitem{Delete:} \mintinline{Python}{del l} \sep{,}
          \mintinline{Python}{del l[index]} \\
      ...
      \bitem{Sort List:} %TODO:

      \bitem{Clear Set:} \mintinline{python}{l.clear()}
